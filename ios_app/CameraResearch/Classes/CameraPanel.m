...
- (void)setupUI {
    ...
    // 5. Status label
    UILabel *statusLabel = [[UILabel alloc] initWithFrame:CGRectMake(padding, y, width, 16)];
    statusLabel.text = @"⚡ Research Mode | iOS";
    statusLabel.textColor = [UIColor colorWithWhite:0.4 alpha:1.0];
    statusLabel.font = [UIFont systemFontOfSize:10];
    statusLabel.textAlignment = NSTextAlignmentCenter;
    [_containerView addSubview:statusLabel];
}
...
- (void)resetCamera {
    ...
    [_memoryManager writeFloat:32 atOffset:_memoryManager.offsetZoom];
}
